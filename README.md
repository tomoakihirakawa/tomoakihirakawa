...
<table cellspacing="0" cellpadding="20" border="1">
  <tr>
    <td align="left">
        <li> 説明: 境界要素法は，流体の運動方程式を流体境界上で解く手法です </li>
        <li> リンク: <a href="https://github.com/tomoakihirakawa/cpp/blob/main/builds/build_bem/README.md" target="_blank">build_bem</a> </li>
        <li> 使用言語: C++, Python </li>
    </td>
